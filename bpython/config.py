...
def _loadini(struct, configfile):
    ...
    if color_scheme_name == 'default' and color_gtk_scheme_name == 'default':
        struct.color_scheme = DEFAULT_COLORS
        struct.color_scheme = DEFAULT_GTK_COLORS
    else:
        _populate_color_scheme(struct, color_scheme_name, color_gtk_scheme_name)


def _populate_color_scheme(struct, color_scheme_name, color_gtk_scheme_name):
    ...
    if color_gtk_scheme_name == 'default':
        ...
        try:
            _load_theme(path, struct.color_gtk_scheme)
        except EnvironmentError:
